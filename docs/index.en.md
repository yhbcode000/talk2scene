...
- 🐛 Issues: [Open an issue](https://github.com/yhbcode000/talk2scene/issues) on GitHub

## 📄 License

Licensed under the [Apache License 2.0](https://github.com/yhbcode000/talk2scene/blob/main/LICENSE).
